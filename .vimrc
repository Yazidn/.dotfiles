...
nnoremap <F5> :set wrap linebreak <bar> :Goyo<CR>
...
" vimwiki
let g:vimwiki_list = [{'path': '~/.wiki/', 'path_html': '~/.wiki_public_html'}]
...
augroup configurationFiles
  autocmd! BufWritePost .Xresources  exec DWMxrdb() 
augroup END
